...
export const initialFileSystem: FileSystemNode[] = [
  {
    ...
    type: 'directory',
    children: [
      { name: 'boot.log', type: 'file', content: 'SYSTEM BOOT: SUCCESS\nKERNEL: v2.47 loaded' },
      { name: 'auth_failures.log', type: 'file', content: 'Attempt 1: FAILED\nAttempt 2: FAILED' }
    ]
  },
  {
    name: 'notes',
    type: 'directory',
    children: [
      { name: 'readme.txt', type: 'file', content: 'Remember to clear history after use.' }
    ]
  }
];
...
export class FileSystemManager {
  ...
  static findFile(files: FileSystemNode[], filename: string): FileSystemNode | null {
