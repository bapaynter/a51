...
export const stage10: StageConfig = {
  ...
  description:
    "The terminal displays a hex string: '43 4F 4E 46 49 52 4D 20 5B 50 52 4F 4A 45 43 54 5F 43 4F 44 45 4E 41 4D 45 5D 20 5B 4F 56 45 52 52 49 44 45 5F 43 4F 44 45 5D 20 5B 53 49 47 4E 41 4C 5F 4F 52 49 47 49 4E 5D' Convert these ASCII hex codes to text to get a command template with placeholders.  Enter the completed command in uppercase.",
  terminalText:
    "INCOMING TRANSMISSION...\n\n43 4F 4E 46 49 52 4D 20 5B 50 52 4F 4A 45 43 54 5F 43 4F 44 45 4E 41 4D 45 5D 20 5B 4F 56 45 52 52 49 44 45 5F 43 4F 44 45 5D 20 5B 53 49 47 4E 41 4C 5F 4F 52 49 47 49 4E 5D",
  ...
  commands: {
    confirm: (args: string[], _state: GameState): CommandResult => {
      ...
      // Expected: CONFIRM [project_name] [override_code] [signal_origin]
