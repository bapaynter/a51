...
export const stage9: StageConfig = {
  ...
  terminalText: "[!] SECURITY COUNTDOWN ACTIVE [!]\n\nTime remaining: 00:03:00\n\nCurrent UTC time displayed below.\nConvert to hexadecimal format to abort.\n\nHANGAR_18>",
